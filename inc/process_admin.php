<?php
	...
	if($page=='view'){
	    ...
	    if ($input['action'] == 'edit') {
	        $update=mysqli_query($conexion,"UPDATE datos SET nombre='" . $input['nombre'] . "', apellido='" . $input['apellido'] . "',  ci='" . $input['ci'] . "', nombre_negocio='" . $input['nombre_negocio'] . "', correo='" . $input['correo'] . "' WHERE id='" . $input['id'] . "'") or die("Error al consultar"); 
