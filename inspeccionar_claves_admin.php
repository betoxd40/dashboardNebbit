...
<body onload="viewData()">
    ...
    <script>
        ...
        function viewData(){
        $.ajax({
            url: 'inc/process_claves_admin.php?p=view',
            method: 'GET'
        }).done(function(data){
            $('tbody').html(data)
            tableData()
    ...
    function tableData(){
        $('#tabledit').Tabledit({
            url: 'inc/process_claves_admin.php',
            eventType: 'dblclick',
            editButton: true,
            deleteButton: true,
            restoreButton: false,
            ...
            columns: {
                identifier: [0, 'id'],
                editable: [[2, 'clave'] , [3, 'fecha_ini'] , [4, 'fecha_fin'] , [5, 'serial'], [6, 'version'] , [7, 'backup']]
            },
