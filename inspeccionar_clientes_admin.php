...
<body onload="viewData()">
    ...
    <script>
        ...
        function viewData(){
        $.ajax({
            url: 'inc/process_admin.php?p=view',
            method: 'GET'
        }).done(function(data){
            $('tbody').html(data)
            tableData()
        ...
        $('#tabledit').Tabledit({
            ...
            buttons: {
                ...
                confirm: {
                    ...
                    html: '<span class="glyphicon glyphicon-ok"></span> Confirmar'
                }
            },
            columns: {
                identifier: [0, 'id'],
                editable: [[1, 'nombre'] , [2, 'apellido'] , [3, 'ci'] , [5, 'correo'], [4, 'nombre_negocio'] , [6, 'correo']]
            },
